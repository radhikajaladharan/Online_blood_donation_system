...
<h1>ORGANIZATION VIEW</h1>
	...
	<table style="margin-left: 180px;margin-top: 50px; background-color: white;">
		<tr>
			<td>Name</td>
			<td>Address</td>
			<td>District</td>
				...
				foreach($n->result() as $row)
				{
					...
					<tr>
						...
						if($row->status==1)
						{
							?>
							<td>approved</td>
							<td><a href="<?php echo base_url()?>main/orgreject/<?php echo $row->id;?>">Reject</a></td>
						...
						elseif($row->status==2)
						{
							?>
							<td>Rejected</td>
							<td><a href="<?php echo base_url()?>main/orgapprove/<?php echo $row->id;?>">Approve
						</a>
						</td>
							<?php
						}
